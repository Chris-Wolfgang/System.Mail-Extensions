...
(function () {
    ...
    function renderPicker(versions) {
        ...
        versions.forEach(function (v) {
            ...
            // NEED `latest` in the list because without it the browser
            // auto-selects the first concrete version (whichever v* is
            // top of the list), and choosing that same value doesn't
            // fire `change`, so the reader can't navigate away to the
